...
USE[Bibliothek]
GO
CREATE PROCEDURE sp_TestVorbestellenBuch @ausweisNr int, @isbn bigint, @titel nvarchar(max), @fachgebiet int, @recht bit, @vname nvarchar(max), @nname varchar(max), @gdatum date, @konto smallmoney, @pw varchar(16)
AS
...
EXEC sp_TestVorbestellenBuch 2, 9999479999, '##_bestelle_buch_vor_test_##', 1, 0, 'vorname_testnutzer', 'nachname_testnutzer', '01.02.1984', 5, 'ts_pw_234'
