...
USE[Bibliothek]
GO
CREATE PROCEDURE sp_TestAnlegenLoeschenExemplar @ausweisNr int , @isbn bigint
AS
...
BEGIN
	...
	BEGIN
		...
		EXECUTE sp_LoescheExemplar @ausweisNr, @ersteSig
		Print 'Prozedur sp_LoescheExemplar wurde ausgefuehrt'
				
		Print 'Versuche ein Exemplar zu loeschen'
		EXECUTE sp_LoescheExemplar @ausweisNr, @zweiteSig
		Print 'Prozedur sp_LoescheExemplar wurde ausgefuehrt'
...
EXEC sp_TestAnlegenLoeschenExemplar 2, 3518260432